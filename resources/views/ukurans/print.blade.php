...
<body>
 ...
 <div class="header text-center mb-4 my-6 "> <!-- Menambahkan style untuk memastikan teks berada di tengah -->
    <h3 style="font-weight: bold; font-family: 'Roboto', sans-serif;">OPTIK ATANG SENDJAJA</h3>
    <p style="font-size: 10px; line-height: 0.5;">Jl. Salabenda Raya No. 3  Kab Bogor</p>
    <p style="font-size: 10px; line-height: 0.25;">Telp. 08573333333</p>
